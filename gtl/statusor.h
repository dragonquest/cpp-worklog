...
#ifndef GTL_STATUSOR_H__
#define GTL_STATUSOR_H__
...
class StatusOr {
 public:
  ...
  inline StatusOr(const ::gtl::Status& status);  // NOLINT
  ...
  // Accessors.
  inline const ::gtl::Status& status() const { return status_; }
...
inline StatusOr<T>::StatusOr()
    : status_(::gtl::error::INTERNAL, "") {}

template <typename T>
inline StatusOr<T>::StatusOr(const ::gtl::Status& status)
    : status_(status) {
